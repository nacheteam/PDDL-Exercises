...
(:objects
    ...
    a1 a2 a3 a4 a5 a6 a7 a8 - aircraft
)
(:init
    ...
    (destino p19 gibraltar)
    (destino p20 gibraltar)
    (destino p21 gibraltar)
    (destino p22 gibraltar)
    ...
    (= (capacity a5) 3000)
    (= (refuel-rate a5) 100)
    (= (maximo-tiempo-vuelo a5) 500)
    (= (capacidad-personas a5) 3)
    (= (personas-dentro a5) 0)
    (= (tiempo-vuelo a5) 0)
    ...
    (= (capacity a6) 3000)
    (= (refuel-rate a6) 100)
    (= (maximo-tiempo-vuelo a6) 500)
    (= (capacidad-personas a6) 3)
    (= (personas-dentro a6) 0)
    (= (tiempo-vuelo a6) 0)
    ...
    (= (capacity a7) 3000)
    (= (refuel-rate a7) 100)
    (= (maximo-tiempo-vuelo a7) 200)
    (= (capacidad-personas a7) 3)
    (= (personas-dentro a7) 0)
    (= (tiempo-vuelo a7) 0)
    ...
    (= (capacity a8) 3000)
    (= (refuel-rate a8) 100)
    (= (maximo-tiempo-vuelo a8) 500)
    (= (capacidad-personas a8) 6)
    (= (personas-dentro a8) 0)
    (= (tiempo-vuelo a8) 0)
...
(:tasks-goal
   ...
   (transport-person p14 cadiz)
   (transport-person p15 cadiz)
   (transport-person p16 cadiz)
   (transport-person p17 cadiz)
   (transport-person p18 gibraltar)
   (transport-person p19 gibraltar)
   (transport-person p20 gibraltar)
   (transport-person p21 gibraltar)
   (transport-person p22 gibraltar)
   (transport-person p23 gibraltar)
   (transport-person p24 almeria)
   (transport-person p25 almeria)
